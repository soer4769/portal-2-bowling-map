...
//		SceneTable["coop_start_results_1_01"] <- {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_tubeone01.vcd"),postdelay=0.5,next="coop_start_results_1_02"}
		...
		SceneTable["botcoop_posthub_tube_zero"] <- {vcd=CreateSceneEntity("scenes/npc/glados/coop/coop_posthub_tube_zero_temp.vcd"),postdelay=0.5,next=null,char="glados",fires=[{entity="@relay_enable_exit",input="Enable",parameter="",delay=0.00}]}
