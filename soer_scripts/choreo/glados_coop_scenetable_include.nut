...
//mp_coop_start                           
	...
	//coop_callibrationcomplete1
		...
		SceneTable["mp_coop_startcoop_callibrationcomplete101"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_callibrationcomplete02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}]}
	...
	//coop_results_1_01
		...
		SceneTable["mp_coop_startcoop_results_1_0100"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startend01.vcd"),postdelay=0.00,next="mp_coop_startcoop_results_1_0100",char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	...
	//mp_coop_startposttaunt
		...
		//Now let's continue testing.
		SceneTable["mp_coop_startmp_coop_startposttaunt03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startend02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//OneBlah
		//Blah.
...
//mp_coop_doors                           
	...
	//mp_coop_doorsend
		...
		SceneTable["mp_coop_doorsmo_coop_doorsend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition01.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}]}
	//mp_coop_doorsstart
...
//mp_coop_race_2                          
	//EndLevel07
		...
		SceneTable["mp_coop_race_2EndLevel0702"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_race_2start
...
//mp_coop_laser_2                         
	...
	//EndLevel04
		...
		//Please continue into the next test chamber.
		SceneTable["mp_coop_laser_2EndLevel0402"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_laserkill
...
//mp_coop_rat_maze                        
	...
	//mp_coop_laser_2endblue
		...
		SceneTable["mp_coop_rat_mazemp_coop_laser_2endblue03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_209.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_laser_2endorange
		...
		SceneTable["mp_coop_rat_mazemp_coop_laser_2endorange03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_210.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_laser_crusher                   
	...
	//mp_coop_laser_crusherdeathend
		...
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherdeathend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crusher01.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_fling_3                         
	//mp_coop_fling_3end
		...
		SceneTable["mp_coop_fling_3mp_coop_fling_3end04"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_3end04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_infinifling_train               
	...
	//mp_coop_infinifling_trainend
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainend04"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_infinifling_trainend04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_infinifling_trainenddeath
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainenddeath00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_1end01_01.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_infinifling_trainendlife
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainendlife00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_1end03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_come_along                      
	//mp_coop_come_alongenddeath
		...
		SceneTable["mp_coop_come_alongmp_coop_come_alongenddeath00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_come_along06.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_come_alongendnodeath
		//And they said no one would ever die during this test, thanks for proving them wrong.
		SceneTable["mp_coop_come_alongmp_coop_come_alongendnodeath00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_come_along04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_catapult_1                      
	//mp_coop_catapult_1end
		...
		SceneTable["mp_coop_catapult_1mp_coop_catapult_1end02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_1end02.vcd"),postdelay=0.00,next="mp_coop_catapult_1mp_coop_catapult_1end03",char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_multifling_1                    
	...
	//mp_coop_multifling_1end
		...
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1end02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidenceoff02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_multifling_1endnodeath
		...
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1endnodeath02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidenceoff04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_fling_crushers                  
	...
	//mp_coop_fling_crushersend
		...
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushersend01.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_fling_crushersend2
		//I think after that display, we should take a break from the official testing courses.
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersend200"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushersend03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_wall_intro                      
	//mp_coop_wall_introstart
		...
		SceneTable["mp_coop_wall_intromp_coop_wall_introstart02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_obstacletrait02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_wall_2                          
	//EndLevel08
		...
		SceneTable["mp_coop_wall_2EndLevel0801"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH08.vcd"),postdelay=0.000,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_wall_2start
		//You did very well.
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_wall_2start2
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start202"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro08.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}],predelay=0.5}
	//mp_coop_wall_2start3
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start304"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro06.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_wall_2start4
		...
		//times in this test.  Not that it matters. It doesn't.  So congratulations  job well done.
		SceneTable["mp_coop_wall_2mp_coop_wall_2start404"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro06.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_catapult_wall_intro             
	...
	//EndLevel12B
		...
		SceneTable["mp_coop_catapult_wall_introEndLevel12B01"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH12.vcd"),postdelay=0.3,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//EndLevel12O
		//Orange
		...
		SceneTable["mp_coop_catapult_wall_introEndLevel12O02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_ONEPLAYER37.vcd"),postdelay=0.2,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//facepalmreply
		//Stop it!
	...
	//mp_coop_wall_introend
		...
		SceneTable["mp_coop_catapult_wall_intromp_coop_wall_introend03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_wall_intro06.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}],predelay=0.5}
//mp_coop_wall_block                      
	//EndLevel05
		...
		//Please continue into the next test chamber.
		SceneTable["mp_coop_wall_blockEndLevel0502"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	...
	//mp_coop_wall_blockend
		...
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_block03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_wall_blockend2
		...
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockend202"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_block04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}]}
...
//mp_coop_catapult_2                      
	//mp_coop_catapult_2end
		...
		SceneTable["mp_coop_catapult_2mp_coop_catapult_2end02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catch03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}],predelay=1}
...
//mp_coop_turret_walls                    
	...
	//mp_coop_turret_wallsend
		...
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_walls04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_turret_wallsend2
		...
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsend200"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_wall01.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_turret_ball                     
	...
	//mp_coop_turret_ballend
		...
		SceneTable["mp_coop_turret_ballmp_coop_turret_ballend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_ball02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_tbeam_redirect                  
	...
	//mp_coop_tbeam_redirectendsc
		...
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectendsc00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc07.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_tbeam_drill                     
	...
	//mp_coop_tbeam_drillend
		...
		SceneTable["mp_coop_tbeam_drillmp_coop_tbeam_drillend02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/COOP_PRIVATETALK_MIX04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_tbeam_catch_grind_1             
	//mp_coop_tbeam_catch_grind_1start
		...
		SceneTable["mp_coop_tbeam_catch_grind_1mp_coop_tbeam_catch_grind_1start02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge17.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//trickfirereply
		//Just stop it already.
		...
		SceneTable["mp_coop_tbeam_catch_grind_1trickfirereply03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_catch_grind_1taunt04.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}],predelay=0.5}
//mp_coop_tbeam_laser_1                   
	...
	//mp_coop_tbeam_laser_1end
		...
		//Still. That would have been exciting.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1end02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catchalt02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}],predelay=1}
	//mp_coop_tbeam_laser_1end2
		//While teamwork is needed to complete these tests, I am not sure I trust the two of you together.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1end200"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge39.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}],predelay=0}
...
//mp_coop_tbeam_polarity                  
	//mp_coop_tbeam_drillendb
		...
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillendb02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge14.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_tbeam_drillendo
		...
		//I trust you.  You are my favorite cooperative testing subject.
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillendo02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge14.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_tbeam_polarity2                 
	...
	//mp_coop_tbeam_polarity2endscb
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2endscb02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge47.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_tbeam_polarity2endsco
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2endsco02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge45.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_tbeam_polarity3                 
	...
	//mp_coop_tbeam_polarity3end
		...
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3end02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_polarity3_17.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}],predelay=1}
...
//mp_coop_tbeam_maze                      
	//mp_coop_tbeam_mazeend
		...
		SceneTable["mp_coop_tbeam_mazemp_coop_tbeam_mazeend02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_maze03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00,fireatstart=true}]}
...
//mp_coop_paint_come_along                
	...
	//mp_coop_paint_come_alongend
		...
		SceneTable["mp_coop_paint_come_alongmp_coop_paint_come_alongend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_come_along11.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_redirect                  
	...
	//mp_coop_paint_redirectend
		...
		SceneTable["mp_coop_paint_redirectmp_coop_paint_redirectend02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_redirect08.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_bridge                    
	...
	//mp_coop_paint_bridgedeath
		...
		SceneTable["mp_coop_paint_bridgemp_coop_paint_bridgedeath02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_bridgedeath02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
	//mp_coop_paint_bridgenodeath
		...
		SceneTable["mp_coop_paint_bridgemp_coop_paint_bridgenodeath02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_bridgenodeath02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_walljumps                 
	//mp_coop_paint_walljumpsend
		...
		SceneTable["mp_coop_paint_walljumpsmp_coop_paint_walljumpsend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_walljumps02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_speed_fling               
	...
	//mp_coop_paint_speed_flingend
		...
		SceneTable["mp_coop_paint_speed_flingmp_coop_paint_speed_flingend02"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_fling03.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_red_racer                 
	...
	//mp_coop_paint_red_racerend
		...
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerend00"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_red_racer02.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}]}
...
//mp_coop_paint_speed_catch               
	//mp_coop_paint_speed_catchend
		...
		SceneTable["mp_coop_paint_speed_catchmp_coop_paint_speed_catchend03"] <- {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catch08.vcd"),postdelay=0.00,next=null,char="glados",fires=[{entity="@relay_exit_started",input="Enable",parameter="",delay=0.00}],predelay=0.5}
