...
// NOT USED, CALLED IN GLADOS DIALOG SYSTEM INSTEAD
...
///////Calibration Course
		case "mp_coop_start": //DONE
			EntFire( "@relay_exit_started", "Trigger", "", 0 )
...
//			GladosPlayVcd(1034) - removed
		...
		case "mp_coop_fling_1":  //deliberatly blank
			EntFire( "@relay_exit_started", "Trigger", "", 0.0 )
			break
		case "mp_coop_catapult_1":  	
			EntFire( "@relay_exit_started", "Trigger", "", 0.0 )
...
///////Subterfuge Buidling Course
		...
		case "mp_coop_tbeam_drill":
			if (IsLocalSplitScreen()){
				...
				EntFire( "@relay_exit_started", "Trigger", "", 15.0 )			
			}
...
//			GladosPrivateTalk(2,5)		
	//		EntFire( "@relay_exit_started", "Trigger", "", 10.0 )			
			break		
		case "mp_coop_tbeam_end":
			GladosPlayVcd(15)		
			break
...
/////////Subterfuge Buidling Course
		case "mp_coop_tbeam_redirect":
			if (IsLocalSplitScreen()){
				...
				EntFire( "@relay_exit_started", "Trigger", "", 13.0 )			
				break		
			}
//		case "mp_coop_tbeam_drill":
//			GladosPrivateTalk(2,4)		
...
//			EntFire( "@relay_exit_started", "Trigger", "", 14.0 )			
//			break		
//		case "mp_coop_tbeam_laser_1":
//			GladosPrivateTalk(2,3)		
//			EntFire( "@relay_exit_started", "Trigger", "", 12.0 )			
//			break		
//		case "mp_coop_tbeam_polarity":
//			if (bluetrust==1)
//			{
